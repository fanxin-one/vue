              ...
              <div class="quick_links">
               ...
               <!-- 图表开始 -->
                <div class="charts_wrap">
                  ...
                  <div style="background:#fff; padding-top:20px; height:340px;">
                    <div style="width:530px; height:370px;" ref="chart04"></div>
                  </div>
                  <div style="background:#fff; padding-top:20px; height:340px;">
                    <div style="width:530px; height:370px;" ref="chart05"></div>
                  </div>
                </div>
        </div>
  </div>
      ...
      mounted:function(){
        document.body.setAttribute("style","background:url(../../static/assets/images/index_body_bg.jpg) !important;min-width:1100px;font-family:'宋体';margin:0;padding:0");
          ...
          if(window.offsetWidth <= 1366){
              ...
              this.$refs.chart04.style.width='90%';
          };
        ...
        var mychart05 = echarts.init(this.$refs.chart05);
        mychart05.setOption ({
            tooltip: {
        trigger: 'item',
        formatter: "{a} <br/>{b}: {c} ({d}%)"
